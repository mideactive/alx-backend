...
def before_request():
    ...
    # Use a try-except block to set the locale, handling unsupported locales gracefully
    try:
        locale.setlocale(locale.LC_TIME, (get_locale(), 'UTF-8'))
    except locale.Error:
        app.logger.warning(f"Unsupported locale: {get_locale()}. Using default locale.")
